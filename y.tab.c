...
static const char *const yytname[] =
{
  ...
  "TOK_FOR", "TOK_DO", "TOK_PRINT", "TOK_SEMICOL", "TOK_IDENT",
  "TOK_STRING", "TOK_AFFECT", "TOK_LPAR", "TOK_RPAR", "TOK_LACC",
  "TOK_RACC", "TOK_COMMA", "TOK_LT", "TOK_RT", "TOK_PLUS", "TOK_MINUS",
  "TOK_MULT", "TOK_DIV", "TOK_REST", "TOK_OPP", "TOK_LOGIC_AND",
  "TOK_LOGIC_OR", "TOK_LOGIC_XOR", "TOK_LDEC", "TOK_RDEC", "TOK_LTEQ",
  "TOK_RTEQ", "TOK_EQ", "TOK_DIF", "TOK_AND", "TOK_OR", "TOK_THEN",
